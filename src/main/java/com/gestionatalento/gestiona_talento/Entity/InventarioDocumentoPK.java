...
@Embeddable
public class InventarioDocumentoPK implements Serializable {
    ...
    public InventarioDocumentoPK() {}

    public InventarioDocumentoPK(Long codEmpleado, Long nroPeriodo) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InventarioDocumentoPK)) return false;
        InventarioDocumentoPK that = (InventarioDocumentoPK) o;
